# API key - JqDwbSdR38EXXrfvUOdC
# ws name - Nithinws
# project id - water-bottles-m3dsi-51jtv
# version - 3
...
class RoboflowDetectorNode(Node):
    ...
    def setup_roboflow_model(self):
        ...
        try:
            ...
            API_KEY = "JqDwbSdR38EXXrfvUOdC"
            WORKSPACE = "nithinws"
            PROJECT = "water-bottles-m3dsi-51jtv"
            VERSION = 3  # Your model version
